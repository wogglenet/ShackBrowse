...
import net.woggle.shackbrowse.PullToRefreshAttacher;
import net.woggle.viewdelegates.AbsListViewDelegate;
import net.woggle.viewdelegates.ScrollYDelegate;
import net.woggle.viewdelegates.WebViewDelegate;
...
public class InstanceCreationUtils {
    ...
    public static PullToRefreshAttacher.ViewDelegate getBuiltInViewDelegate(final View view) {
