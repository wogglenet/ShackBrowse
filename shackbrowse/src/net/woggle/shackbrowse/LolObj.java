...
public class LolObj {
	...
	LolObj(int lol, int inf, int unf, int tag, int wtf, int wow) {
		setLol(lol); setInf(inf); setUnf(unf); setTag(tag); setWtf(wtf); setWow(wow);
	}
	public String lolObjToString()
	{
		return getLol() + ":" + getInf() + ":" +getUnf() + ":" + getTag() + ":" + getWtf() + ":" + getWow();
	}
	...
	public void setWow(int val) { _wow = val; }
	...
	public void incWow() { _wow = _wow+1; }
	...
	public void decWow() { _wow = _wow-1; }
	public void clear () { _lol = 0; _inf = 0; _unf = 0; _tag = 0; _wtf = 0; _wow = 0; }
	...
	public SpannedString makeTagSpan(Context context) {
		SpannableString lol = new SpannableString(""), inf = new SpannableString(""), unf = new SpannableString(""), tag = new SpannableString(""), wtf = new SpannableString(""), wow = new SpannableString("");
        ...
        SpannedString formatted = (SpannedString)TextUtils.concat(lol,inf,unf,tag,wtf,wow);
