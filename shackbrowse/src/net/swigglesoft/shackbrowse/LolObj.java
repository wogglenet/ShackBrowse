...
public class LolObj {
	...
	LolObj(int lol, int inf, int unf, int tag, int wtf, int wow, int aww) {
		setLol(lol); setInf(inf); setUnf(unf); setTag(tag); setWtf(wtf); setWow(wow); setAww(aww);
	}
	...
	public void setAww(int val) { _aww = val; }
	...
	public void incAww() { _aww = _aww+1; }
	...
	public void decAww() { _aww = _aww-1; }
	public void clear () { _lol = 0; _inf = 0; _unf = 0; _tag = 0; _wtf = 0; _wow = 0; _aww = 0; }
